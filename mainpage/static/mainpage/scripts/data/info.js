const bachalorInfo = [
    {
        ...
        cards: [
            "Разрабатывать концепции развития бизнеса на основе информационно-коммуникационных технологий",
            "Разрабатывать архитектуру ИТ-инфраструктуры предприятия",
            "Осуществлять систематическое планирование и развитие ИТ-инфраструктуры",
            "Принимать стратегические решения в части выбора и внедрения информационных систем (ИС) и информационно- коммуникационных технологий (ИКТ) на предприятии"
        ]
    },
    {
        ...
        cards: [
            "Продвигать бренд и привлекать клиентов с помощью всех возможных цифровых каналов",
            "Работать с различными видами интернет-продвижения: SEO, PPC, SMM, email-маркетинг и др.",
            "Находить решения в сложных продуктовых ситуациях, реализовывать различные цифровые маркетинг-стратегии",
            "Анализировать и управлять маркетинг-проектами"
        ]
    },
    {
        ...
        cards: [
            "Анализировать и моделировать экономические процессы на микро- и макро- уровнях ",
            "Прогнозировать стратегию развития бизнеса",
            "Применять методы банковской и страховой статистики",
            "Делать финансовый анализ, анализ фондового рынка, анализировать международные экономические проблемы"
        ]
    }
]
...
const masterInfo = [
    {
        ...
        cards: [
            ...
            "Руководить подразделениями предприятий и организаций",
            "Организовывать команды для решения организационно-управленческих задач и руководить ими",
            "Анализировать и оценивать информацию для подготовки и принятия управленческих решений, совершенствовать процессы управления"
        ]
    },
    {
        ...
        cards: [
            "Разрабатывать новые идеи и бизнес-модели и оптимизировать бизнес-процессы с помощью информационно-коммуникационных технологий ",
            "Осуществлять финансовые и торговые транзакций при помощи компьютерных сетей",
            "Готовить аналитические материалы для оценки мероприятий и выработки стратегических решений в области ИКТ",
            "Анализировать инновационную деятельность предприятий, разрабатывать стратегии развития архитектуры предприятий"
        ]
    }
]
